...
CREATE TABLE [Contracts] (
    ...
    CONSTRAINT [FK_Contracts_AspNetUsers_ClientId] FOREIGN KEY ([ClientId]) REFERENCES [AspNetUsers] ([Id]) ON DELETE NO ACTION
);
...
VALUES (N'20260423182518_InitialCreate', N'10.0.7');
